      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {id: "sidebar"}, 
          React.createElement("header", null, 
            React.createElement("h1", null, React.createElement(Icon, {type: "mountains", width: "24", height: "24"}), " Pronto Routes")
          ), 
...
//        disableDefaultUI: true
  ...
  statics: {
    pinpointMarker: new google.maps.Marker({
      ...
      clickable: false,
      zIndex: 1000,
      icon: Meteor.absoluteUrl('bike_marker.png')
    }),
    ...
    if (data && data.length){
      ...
      return (
        React.createElement("div", {id: "routes-container"}, 
          ...
          React.createElement("p", null, "Try an example: ", React.createElement("a", {href: "#bicycling/Seattle Center, Seattle/Washington Park, Seattle"}, "Seattle Center to Washington Park"))
        )
      )
    }
  }
